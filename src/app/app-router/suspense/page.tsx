  ...
  return (
    <div>
      ...
      <Description>
        ...
        <code>Suspense</code> would make navigation as fast as the Pages Router,
        but that&apos;s not what happens. While navigation does become faster
        than in the previous demo, there&apos;s still a slight delay between
        clicking the link and seeing the rendered page.
      </Description>
